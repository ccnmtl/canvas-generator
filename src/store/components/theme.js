...
export default {
  state: {
    theme: { option: "Columbia", banner: 'CU01', slim: 'CU01_Slim', logo: IMAGE_SERVER + "SipaLogo2.png" },
    themeOptions:[
      // { option: "Default", banner: '', slim: '', logo: IMAGE_SERVER + "SipaLogo2.png" },
      { option: "Columbia", banner: 'CU01', slim: 'CU01_Slim', logo: IMAGE_SERVER + "CU_Default_Logo.png" },
      { option: "SIPA", banner: 'SIPA', slim: 'SIPA_Slim', logo: IMAGE_SERVER + "SipaLogo2.png" },
