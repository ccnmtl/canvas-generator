  ...
  <div class="hello">
    ...
    <div class="code-container">
      ...
      <div class="textbox-container">
        ...
        <el-collapse-item title="Course Title" name="1">
          <el-input v-model="title" ></el-input>
        </el-collapse-item>
        <el-collapse-item title="Semester">
          <el-input v-model="semester" ></el-input>
        </el-collapse-item>
        <el-collapse-item title="Professor">
          <el-input v-model="professor" ></el-input>
        </el-collapse-item>
        <el-collapse-item title="Professor Email">
          <el-input v-model="pEmail" ></el-input>
        </el-collapse-item>
        ...
        <el-collapse-item title="TA">
        <el-input v-model="ta" ></el-input>
        </el-collapse-item>

        <el-collapse-item title="TA Email">
        <el-input v-model="tEmail" ></el-input>
        </el-collapse-item>

        <el-collapse-item title="Office Hours">
        <el-input v-model="office" ></el-input>
        </el-collapse-item>

        <el-collapse-item title="Meeting Times">
        <el-input v-model="meetings" ></el-input>
        </el-collapse-item>

        <el-collapse-item title="Discussions">
        <el-input v-model="discussions" ></el-input>
        </el-collapse-item>

        <el-collapse-item title="Description">
        <el-input :multi-line="true" :rows="5" v-model="description" ></el-input>
        </el-collapse-item>

        <el-collapse-item title="Video Link">
...
<style scoped href="https://unpkg.com/vue-material@0.7.1/dist/vue-material.css"> </style>
<style scoped href="https://unpkg.com/element-ui/lib/theme-default/index.css"> </style>
